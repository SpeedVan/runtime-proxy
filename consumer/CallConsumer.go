...
// New todo
func New(name string, endpoint string, localhttpcall service.Call, streamNames []string) (*CallConsumer, error) {
...
func (s *CallConsumer) Subscribe() {
	fmt.Printf("all streams: %v", s.StreamNames)
	for _, sn := range s.StreamNames {
